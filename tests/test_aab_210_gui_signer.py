...
OUTPUT_AAB = INPUT_AAB.with_name("WorldRevolutionNews-2.1.0-code25-6a86e75-signed.aab")
REPORT = INPUT_AAB.with_name("WorldRevolutionNews-2.1.0-code25-6a86e75-signed.signature-report.json")
...
def test_exact_local_preflight_is_read_only() -> None:
    ...
    assert not OUTPUT_AAB.exists(), "Signed output already exists; overwrite safety cannot be preflighted"
    assert not REPORT.exists(), "Signature report already exists; overwrite safety cannot be preflighted"
